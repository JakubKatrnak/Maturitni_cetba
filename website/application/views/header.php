...
<head>
    ...
    <script type="text/javascript" src="http://js.nicedit.com/nicEdit-latest.js"></script> <!-- enhanced textarea -->
                ...
                <nav id="main-navbar" class="navbar bg-primary navbar-expand-lg w-100">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-collapse">
                        <a class="navbar-brand text-white" href="<?php echo base_url(''); ?>">
                            Domů
                            <img src="<?php echo base_url('img/logo-transparent.png') ?>" width="30" height="30" class="ml-3 d-inline-block align-top" alt="">
                        </a>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                    ...
                    <ul class="navbar-nav navbar-right d-none d-md-none d-lg-inline">
                        <!-- pro velké zařízení -->
                    ...
                    <ul class="navbar-nav navbar-right d-lg-none d-md-inline d-inline">
                        <!-- pro malé zařízení -->
                        <?php if ($this->session->userdata('logged_in') === TRUE) : ?>
